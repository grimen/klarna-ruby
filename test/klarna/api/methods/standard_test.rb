...
describe Klarna::API::Methods::Standard do
  ...
  describe '#get_addresses' do
    it 'should be defined' do
      assert_respond_to @client, :get_addresses
    end

    # it 'should require: pno, country'

    it 'should handle pno-format as integer (pno-format ID)' do
      assert @client.get_addresses("4304158399", 2) # a.k.a. ::Klarna::API::PNO_FORMATS[:SE]
    end

    it 'should handle pno-format as integer (pno-format ID)' do
      assert @client.get_addresses("4304158399", :SE)
    end
    ...
    describe "SE" do
      it 'should return address for a valid pno' do
        result = @client.get_addresses("4304158399", :SE)
        assert_equal [@protocol_version, @user_agent, "4304158399", 2, "AY2qnVNi8ccTsuDw2XNovQ==", 2, 1], @client.last_request_params
        assert_equal [["Karl", "Lidin", "Junibacksg 42", "23634", "Hollviken", 209]], result

        result = @client.get_addresses("5311096845", :SE)
        assert_equal [@protocol_version, @user_agent, "5311096845", 2, "55EEK/36aGSeBYlYgBDzGg==", 2, 1], @client.last_request_params
        assert_equal [["Maud", "Johansson", "Köpmansg 7", "12149", "Johanneshov", 209]], result
      end

      it 'should ignore format symbols in pno' do
        result = @client.get_addresses("430415-8399", :SE)
        assert_equal [@protocol_version, @user_agent, "4304158399", 2, "AY2qnVNi8ccTsuDw2XNovQ==", 2, 1], @client.last_request_params
      end
    end
  end
  ...
  describe '#get_address' do
    it 'should be defined' do
      assert_respond_to @client, :get_address
    end

    it 'should only return first returned address for a valid SSN' do
      result = @client.get_address("4304158399", :SE)
      assert_equal ["Karl", "Lidin", "Junibacksg 42", "23634", "Hollviken", 209], result
    end
  end
  ...
  describe '#make_address' do
    it 'should be defined' do
      assert_respond_to @client, :make_address
    end
    ...
    describe "SE" do
      it 'should generate an valid address array' do
        assert_equal ({
          ...
          @client.make_address("c/o Lidin", "Junibackg. 42", "23634", "Hollviken", :SE, "076 526 00 00", "076 526 00 00", "karl.lidin@klarna.com")
      end
  ...
  describe '#make_goods' do
    it 'should be defined' do
      assert_respond_to @client, :make_goods
    end
    ...
    it 'should generate an valid address structure: quantity, artno, title, price, vat' do
      assert_equal ({
        ...
        @client.make_goods(5, "ABC123", "T-shirt", 25.00 * 100, 25)
    end
    ...
    it 'should generate an valid address structure: quantity, artno, title, price, vat, discount' do
      assert_equal ({
        ...
        @client.make_goods(5, "ABC123", "T-shirt", 25.00 * 100, 25, 10)
    end
    ...
    it 'should generate an valid address structure: quantity, artno, title, price, vat, discount, flags' do
      assert_equal ({
        ...
        @client.make_goods(5, "ABC123", "T-shirt", 25.00 * 100, 25, 10, ::Klarna::API::GOODS[:INC_VAT])
    end
    ...
    it 'should be possible to set flags via options' do
      assert_equal ({
        ...
        @client.make_goods(5, "ABC123", "T-shirt", 25.00 * 100, 25, 0, :inc_vat => true, :is_handling => true)
    end
  end
  ...
  describe '#has_account?' do
    it 'should be defined' do
      assert_respond_to @client, :has_account?
    end
  end
