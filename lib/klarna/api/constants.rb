  ...
  module API
    module Constants
      ...
      END_POINT = {
        :test => {
          :protocol => 'http',
          :host => 'beta-test.kreditor.se',
          :port => 4567
        },
        :production => {
          :protocol => 'https',
          :host => 'payment.kreditor.se',
      ...
      # -----------------------------------------------------------------------
      #  Mode: Personal Number Encodings
      # -----------------------------------------------------------------------
      module PersonalNumberFormats
        FAKE = 1
        SE = 2
        NO = 3
        FI = 4
      ...
      COUNTRY_DEFAULTS = {
        :SE => {
          ...
          :pno      => PersonalNumberFormats::SE,
          :interest_rate => InterestRates::SE
        },
        :NO => {
          :country  => Countries::NO,
          :lang     => Languages::NB,
          :currency => Currencies::NOK,
          :pno      => PersonalNumberFormats::NO,
          :interest_rate => InterestRates::NO
        },
        :DK => {
          :country  => Countries::DK,
          :lang     => Languages::DA,
          :currency => Currencies::DKK,
          :pno      => PersonalNumberFormats::DK,
          :interest_rate => InterestRates::DK
        },
        :FI => {
          :country  => Countries::FI,
          :lang     => Languages::FI,
          :currency => Currencies::EUR,
          :pno      => PersonalNumberFormats::FI,
          :interest_rate => InterestRates::FI
        },
        :DE => {
          :country  => Countries::DE,
          :lang     => Languages::DE,
          :currency => Currencies::EUR,
          :pno      => PersonalNumberFormats::DE,
          :interest_rate => InterestRates::DE
        }
      }
